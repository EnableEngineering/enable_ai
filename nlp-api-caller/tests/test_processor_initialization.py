"""
Unit test for NLPProcessor initialization with config.json.
...
# Try to import environment module for config/env path detection
try:
    import environment
...
from nlp_api_caller.processor import NLPProcessor
...
class TestProcessorInitialization(unittest.TestCase):
    ...
    def test_processor_loads_schemas_for_enabled_data_sources(self):
        ...
        processor = NLPProcessor(config_path=str(self.config_path))
...
class TestSchemaValidation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.processor = NLPProcessor(config_path=str(self.config_path))
...
def run_tests():
    ...
    print("=" * 80)
    print("Testing NLPProcessor Initialization with config.json")
    print("=" * 80)
